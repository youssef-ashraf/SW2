...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="{{asset('uploads/settings')}}/favicon.ico">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>               
                                        ...
                                        <li><a href="{{route('front.homepage')}}">Home</a></li>
                                            <li><a href="{{route('front.flight')}}">Flight</a></li>
                                            <li><a href="{{route('front.log')}}">Log/Reg</a></li>
                                            <li><a href="{{route('front.showreserve')}}">Reserve</a></li>
