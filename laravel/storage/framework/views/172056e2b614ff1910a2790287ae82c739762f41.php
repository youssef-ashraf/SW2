    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(route('admin.deleteuser')); ?>">Delete User</a>
            <a class="collapse-item" href="<?php echo e(route('admin.view_user')); ?>">View Users </a>
            <a class="collapse-item" href="<?php echo e(route('admin.adduser')); ?>">Add User </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(route('admin.deleteflight')); ?>">Delete Flight</a>
            <a class="collapse-item" href="<?php echo e(route('admin.view_flight')); ?>">View_Flight</a>
			      <a class="collapse-item" href="<?php echo e(route('admin.addflight')); ?>">Add Flight </a>
          </div>
        </div>
      </li>
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(route('admin.addticket')); ?>">Book Flight</a>
            <a class="collapse-item" href="<?php echo e(route('admin.view_ticket')); ?>">View Tickets </a>
            <a class="collapse-item" href="<?php echo e(route('admin.deleteticket')); ?>">delete Tickets </a>
...
<?php /**PATH C:\Users\catym\Desktop\flight github\SW2\laravel\resources\views/admin/control.blade.php ENDPATH**/ ?>