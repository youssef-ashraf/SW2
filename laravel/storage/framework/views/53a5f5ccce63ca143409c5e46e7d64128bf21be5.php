<footer>
        <!-- Footer Start-->
        <div class="footer-area footer-padding footer-bg" data-background="<?php echo e(asset('front/img')); ?>/service/footer_bg.jpg">
            <div class="container">
	...
	<!-- JS here -->
		...
		<script src="<?php echo e(asset('front/js')); ?>/vendor/jquery-1.12.4.min.js"></script>
		...
		<script src="<?php echo e(asset('front/js')); ?>/animated.headline.js"></script>
        <script src="<?php echo e(asset('front/js')); ?>/jquery.magnific-popup.js"></script>
...
</html><?php /**PATH C:\Users\catym\Desktop\github flight2\SW2\laravel\resources\views/front/inc/footer.blade.php ENDPATH**/ ?>